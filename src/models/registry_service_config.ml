 ...
 *
 * Schema Registry_service_config.t : RegistryServiceConfig stores daemon registry services configuration. 
 *)
...
type t = {
    ...
    allow_nondistributable_artifacts_cidrs: string list;
    ...
    allow_nondistributable_artifacts_hostnames: string list;
    ...
    insecure_registry_cidrs: string list;
    index_configs: (string * Index_info.t) list;
...
let create () : t = {
    allow_nondistributable_artifacts_cidrs = [];
